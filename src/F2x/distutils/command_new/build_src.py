    ...
    def build_sources(self):
        ...
        if self.extensions:
            ...
            for extension in self.extensions:
                ...
                extension.output = self.select_sources(extension, strategy, target_dir, sources_to_wrap)
        ...
        if wrap_input:
            for _, template_file, _, template_dir in templates:
                ...
                for source_file, target_file, output, depends in wrap_input:
                    wrap_output += [filename for filename in output if filename not in wrap_output]
